...
import { LubProcedure, Procedimento } from '../../types';
import {
    Container,
    List,
    IconButton,
...
interface PropsListaProcedimentos {
    ...
    handleChangeProcedures: (value: LubProcedure[]) => void;
}

type AllProps = PropsListaProcedimentos;

const getInitialProcedure = (): LubProcedure => {
    return {
        condition: 'PARADA',
        description: '',
        item: '',
...
const ListaProcedimentos: FC<AllProps> = (props: AllProps) => {
    ...
    const [procedureAdded, setProcedureAdded] = useState<LubProcedure>(getInitialProcedure());
        ...
        <List>
                ...
                >
                    ...
                    <TextField
                        ...
                        onChange={(event: React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) => {
                            const newProcedures = [...props.lubprocedures];
                            newProcedures[index] = {
                                ...newProcedures[index],
                    ...
                    <TextField
                        ...
                        onChange={(event: React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) => {
                            ...
                            newProcedures[index] = {
                                ...newProcedures[index],
                                lubricant: event.currentTarget.value,
                            };
                            props.handleChangeProcedures(newProcedures);
                        }}
                    />
            ...
            <Container className={classes.listItem}>
                ...
                <TextField
                    ...
                    variant="outlined"
                    label="Lubrificante"
                    value={procedureAdded.lubricant || ' '}
                    onChange={(event: React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) => {
                        setProcedureAdded({
                            ...procedureAdded,
                            lubricant: event.currentTarget.value,
